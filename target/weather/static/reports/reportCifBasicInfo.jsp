	...
	//初始化列表
   	$('#dataTable').datagrid({
   		...
   		columns:[[
					...
					{field:'managerCom', title:'机构',width : 100,align : 'center',rowspan:2},
					{field:'cityName',title:'城市',width : 100,align : 'center',rowspan:2},
					{field:'totalNum', title:'总量',width : 100,align : 'center',rowspan:2},
					{field:'', title:'性别',width : 100,align : 'center', colspan:2},
					{field:'', title:'年龄',width : 100,align : 'center', colspan:6},
					{field:'',title:'婚姻状况',width : 100,align : 'center', colspan:2}
				],[
					{field:'maleCustomerNum',title:'男',width : 100,align : 'center'},
					{field:'femaleCustomerNum',title:'女',width : 100,align : 'center'},
					{field:'averageAge',title:'平均年龄',width : 100,align : 'center'},
					{field:'underTweNum',title:'20及以下',width : 100,align : 'center'},
					{field:'tweToThiNum',title:'20-30',width : 100,align : 'center'},
					{field:'thiToForNum',title:'30-40',width : 100,align : 'center'},
					{field:'forToFifNum',title:'40-50',width : 100,align : 'center'},
					{field:'moreThanFifNum',title:'51及以上',width : 100,align : 'center'},
					{field:'marriage',title:'已婚',width : 100,align : 'center'},
					{field:'others',title:'其他情况',width : 100,align : 'center'}
				   ]
   				],
   	...
   	$('#month').combobox({
   		url:"${basePath}/service/cifBasicInfo/month",    
...
<script type="text/javascript">
	...
	function submitForm() {
		...
		var url="${basePath}/service/cifBasicInfo/detail?freshtime=" + new Date().getTime();
